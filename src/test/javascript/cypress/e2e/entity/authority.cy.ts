...
describe('Authority e2e test', () => {
  ...
  const authoritySample = { name: 'c70d2cf7-a9e5-443d-bbf6-da65e2cc5a61' };
  ...
  describe('new Authority page', () => {
    ...
    it('should create an instance of Authority', () => {
      cy.get(`[data-cy="name"]`).type('529410d2-9916-44c3-b497-a537593008af');
      cy.get(`[data-cy="name"]`).should('have.value', '529410d2-9916-44c3-b497-a537593008af');
